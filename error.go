...
const (
	...
	TransferErr    ErrorType = "transfer_error"
	...
	AcctClosed        ErrorCode = "account_closed"
	NoAccount         ErrorCode = "no_account"
	InvalidAccountNum ErrorCode = "invalid_account_number"
	DebitNotAuth      ErrorCode = "debit_not_authorized"
	BankOwnerDiff     ErrorCode = "bank_ownership_changed"
	AcctFrozen        ErrorCode = "account_frozen"
	CouldNotProcess   ErrorCode = "could_not_process"
	BankAcctRestr     ErrorCode = "bank_account_restricted"
	InvalidCur        ErrorCode = "invalid_currency"
)
